...
export function StartupListPage(props: StartupListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getStartups({
        relations: ['user', 'capital_requirement.count', 'investment.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('capital_requirement', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'capital_requirement',
          header: 'Capital Requirement',
          accessorKey: 'capital_requirement',
          cell: ({ row: { original: record } }: any) => record?._count?.capital_requirement,
        }
      : null,
    hasAccess('investment', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.investment,
        }
      : null,
