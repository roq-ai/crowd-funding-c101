...
import { getCapitalRequirementById } from 'apiSdk/capital-requirements';
import { CapitalRequirementInterface } from 'interfaces/capital-requirement';

function CapitalRequirementViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Capital Requirement Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('capital_requirement', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/capital-requirements/edit/${id}`} passHref legacyBehavior>
                    <Button
